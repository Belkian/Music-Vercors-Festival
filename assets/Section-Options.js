...
function checkTente() {
    ...
    if (tenteNuit1.checked == true && tenteNuit2.checked == true && tenteNuit3.checked == true) {
        tente3Nuits.checked = true;
        tenteNuit1.checked = false;
        tenteNuit2.checked = false;
        tenteNuit3.checked = false;
    }
    if (tente3Nuits.checked == true && tenteNuit1.checked == true || tenteNuit2.checked == true || tenteNuit3.checked == true) {
...
function checkVan() {
    ...
    if (vanNuit1.checked == true && vanNuit2.checked == true && vanNuit3.checked == true) {
        van3Nuits.checked = true;
        vanNuit1.checked = false;
        vanNuit2.checked = false;
        vanNuit3.checked = false;
    }
    if (van3Nuits.checked == true && vanNuit1.checked == true || vanNuit2.checked == true || vanNuit3.checked == true) {
